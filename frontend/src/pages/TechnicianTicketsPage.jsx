...
import { useAuth } from "../context/AuthContext";import { useNotifications } from "../context/NotificationContext";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {tickets.map((t) => (
            <Link key={t.id} to={`/tickets/${t.id}`} style={{
              ...
              <span style={{ background: P_BG[t.priority], color: P_COLOR[t.priority], fontSize: 11.5, fontWeight: 600, padding: "4px 10px", borderRadius: 20 }}>{P_LABEL[t.priority] || t.priority}</span>
...
const DEMO = [
  { id: 3, title: "Imprimante HS bloc admin", priority: "HIGH", status: "OUVERT", createdAt: new Date().toISOString() },
  { id: 5, title: "Virus détecté poste #41", priority: "CRITICAL", status: "EN_COURS", createdAt: new Date().toISOString() },
];
