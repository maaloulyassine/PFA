    ...
    Promise.all([
      ...
      try {
        ...
        tickets.forEach(t => {
          ...
          const c = (t.category?.name) || (typeof t.category === "string" ? t.category : "Non défini");
          ...
          <div className="bar-chart">
            {(pData || []).map((d, i) => (
              <div key={d.priority} className="bar-row">
                <div className="bar-label">{{ CRITICAL: "Critique", HIGH: "Élevée", MEDIUM: "Moyenne", LOW: "Faible" }[d.priority] || d.priority}</div>
...
const DEMO_DATA = {
  ...
  priority: [
    { priority: "CRITICAL", count: 18 }, { priority: "HIGH", count: 34 },
    { priority: "MEDIUM", count: 57 }, { priority: "LOW", count: 36 }
  ],
  category: [
