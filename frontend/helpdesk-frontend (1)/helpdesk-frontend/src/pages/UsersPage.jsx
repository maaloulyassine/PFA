...
const SPECIALTIES = ["Réseau", "Logiciel", "Matériel", "Sécurité"];
            ...
            <tbody>
              {filtered.map((u) => (
                <tr key={u.id}>
                  ...
                  <td className="specialty-cell">{u.specialty || <span className="na">—</span>}</td>
...
const DEMO_USERS = [
  { id: 1, firstName: "Mohamed", lastName: "Trabelsi", email: "m.trabelsi@fsm.rnu.tn", role: "TECHNICIEN", specialty: "Réseau" },
